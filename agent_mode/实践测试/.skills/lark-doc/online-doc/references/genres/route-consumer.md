...
用于帮助读者购买、比较、避坑或判断某种生活方式是否适合自己。仅出现小红书、微信等平台名不触发；明确要求最终交付小红书笔记、微信公众号文章、邮件或短视频稿时，保留本合同并叠加读取 [`media-and-communication.md`](media-and-communication.md)。消费选择任务仍为硬约束，adapter 只决定渠道成稿形式。以公共事件核实为主走 Media，以价值判断为主走 Opinion，以品牌拥有的转化内容走 Marketing。
