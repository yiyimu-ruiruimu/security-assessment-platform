...
以立场说服为主走 Opinion；以购买决策和亲身体验为主走 Consumer；内部事实简报不因写得像新闻而改变读者任务。渠道名、标题风格或“像媒体一样写”均不能单独触发；明确要求最终交付小红书笔记、微信公众号文章、邮件或短视频稿时，保留本合同并叠加读取 [`media-and-communication.md`](media-and-communication.md)。资讯核实边界仍为硬约束，adapter 只决定渠道成稿形式。
